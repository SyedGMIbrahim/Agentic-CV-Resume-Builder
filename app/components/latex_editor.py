...
def render_latex_editor() -> bool:
    ...
    # Add PDF preview after the editor and controls
    st.markdown("---")
...
def compile_latex_to_pdf():
    ...
    with st.spinner("Compiling LaTeX to PDF..."):
        ...
        if pdf_path:
            ...
            # keep a reference to the generator so the temp files aren't cleaned up
...
def update_latex_from_data():
    ...
    try:
        ...
        if new_latex:
            ...
            # Ensure the generated PDF path is available to preview/download controls
            if pdf_path:
                st.session_state.pdf_path = pdf_path
                # keep a reference to the generator to avoid accidental cleanup
                st.session_state.pdf_generator = pdf_generator
